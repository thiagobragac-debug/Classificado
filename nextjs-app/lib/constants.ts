...
export const I18N = {
  pt: {
    ...
    fc_imoveis: 'Imóveis Rurais', fc_imoveis_sub: 'fazendas e sítios',
    ...
    err_pass_weak: 'A senha deve ter pelo menos uma letra e um número.',
    ...
    events_load_error: 'Erro ao carregar eventos. Tente novamente em instantes.',
  ...
  es: {
    ...
    fc_imoveis: 'Inmuebles Rurales', fc_imoveis_sub: 'estancias y chacras',
    ...
    err_pass_weak: 'La contraseña debe tener al menos una letra y un número.',
    ...
    events_empty_for: 'para',
    events_load_error: 'Error al cargar los eventos. Intentá de nuevo en unos instantes.',
