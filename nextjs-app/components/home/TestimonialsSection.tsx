        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
          {testimonials?.map((testi: any) => (
            <div key={testi.id} className="glass-card" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
              ...
              <p style={{ color: '#334155', fontSize: '1.05rem', lineHeight: 1.6, fontStyle: 'italic', flex: 1, marginBottom: '2rem', position: 'relative', zIndex: 1 }}>"{lang === 'es' && testi.text_es ? testi.text_es : testi.text}"</p>
